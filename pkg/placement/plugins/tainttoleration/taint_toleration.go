...
func (pl *TaintToleration) Description() string { //nolint:staticcheck
	return description
}
...
func getDecisionClusterNames(handle plugins.Handle, placement *clusterapiv1beta1.Placement) sets.String { //nolint:staticcheck
	existingDecisions := sets.String{} //nolint:staticcheck
