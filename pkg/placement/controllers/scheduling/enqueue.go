...
type enqueuer struct {
	...
	enqueuePlacementFunc func(obj interface{}, queue workqueue.RateLimitingInterface) //nolint:staticcheck
...
func enqueuePlacement(obj interface{}, queue workqueue.RateLimitingInterface) { //nolint:staticcheck
