...
var _ = ginkgo.BeforeSuite(func() {
	...
	case util.MQTTDriver:
		...
		clientOptions := options.NewGenericClientOptions(util.NewMQTTSourceOptions(sourceID), sourcecodec.NewManifestBundleCodec(), fmt.Sprintf("%s-%s", sourceID, rand.String(5))).
