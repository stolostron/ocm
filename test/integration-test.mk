...
test-registration-integration: envtest-setup
	...
	./registration-integration.test -ginkgo.slow-spec-threshold=15s -ginkgo.v ${ARGS}
.PHONY: test-registration-integration

test-work-integration: envtest-setup build-work-integration
	./work-integration.test -ginkgo.slow-spec-threshold=15s -ginkgo.v ${ARGS}
...
test-placement-integration: envtest-setup
	...
	./placement-integration.test -ginkgo.slow-spec-threshold=15s -ginkgo.v ${ARGS}
...
test-registration-operator-integration: envtest-setup
	...
	./registration-operator-integration.test -ginkgo.slow-spec-threshold=15s -ginkgo.v ${ARGS}
...
test-addon-integration: envtest-setup
	...
	./addon-integration.test -ginkgo.slow-spec-threshold=15s -ginkgo.v ${ARGS}
...
test-cloudevents-work-mqtt-integration: envtest-setup build-work-integration
	./work-integration.test -ginkgo.slow-spec-threshold=15s -ginkgo.v \
